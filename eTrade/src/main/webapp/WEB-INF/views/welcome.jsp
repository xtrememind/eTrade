				  ...
				  <div class="container">
					<c:choose>
					    ...
					    <c:otherwise>
		 					...
		 					<br>
		 					<a href="<spring:url value="/stocks/add" />" class="btn btn-default pull-right">Add Stock</a>	
		 					<a href="<spring:url value="/stocks/all" />" class="btn btn-default pull-right">Stock List</a>	
		 					<br>
